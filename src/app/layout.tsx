...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <meta name="description" content="Center Of Hope - Ensuring every child fulfil their potential by helping them access  quality education and empowering skills " />
